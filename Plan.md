...
***Шаги***
    ...
    Шаг 3
      - заполение формы невалидымыи значениями 
          ...
          - недопустимое количество символов для номера карты
          - русские буквы в наименовании владельца 

***Ожидаемый результат***

    Сообщение об ошибке снизу некорректно заполненного поля, выделенное красным цветом
...
***Ожидаемый результат***
    ...
    Сообщение об ошибке, что такой карты не существуют
